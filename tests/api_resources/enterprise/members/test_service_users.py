...
class TestServiceUsers:
    ...
    def test_method_retrieve(self, client: DevinPlatform) -> None:
        service_user = client.enterprise.members.service_users.retrieve(
    ...
    def test_raw_response_retrieve(self, client: DevinPlatform) -> None:
        response = client.enterprise.members.service_users.with_raw_response.retrieve(
            "service-user-abc123def456",
        )
    ...
    def test_streaming_response_retrieve(self, client: DevinPlatform) -> None:
        with client.enterprise.members.service_users.with_streaming_response.retrieve(
            "service-user-abc123def456",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            client.enterprise.members.service_users.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: DevinPlatform) -> None:
        service_user = client.enterprise.members.service_users.update(
    ...
    def test_raw_response_update(self, client: DevinPlatform) -> None:
        response = client.enterprise.members.service_users.with_raw_response.update(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
    ...
    def test_streaming_response_update(self, client: DevinPlatform) -> None:
        with client.enterprise.members.service_users.with_streaming_response.update(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            client.enterprise.members.service_users.with_raw_response.update(
                service_user_id="",
                role_id="role_id",
            )
    ...
    def test_method_list(self, client: DevinPlatform) -> None:
        service_user = client.enterprise.members.service_users.list()
    ...
    def test_raw_response_list(self, client: DevinPlatform) -> None:
        response = client.enterprise.members.service_users.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: DevinPlatform) -> None:
        with client.enterprise.members.service_users.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: DevinPlatform) -> None:
        service_user = client.enterprise.members.service_users.delete(
            "service-user-abc123def456",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    def test_raw_response_delete(self, client: DevinPlatform) -> None:
        response = client.enterprise.members.service_users.with_raw_response.delete(
            "service-user-abc123def456",
        )
    ...
    def test_streaming_response_delete(self, client: DevinPlatform) -> None:
        with client.enterprise.members.service_users.with_streaming_response.delete(
            "service-user-abc123def456",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            client.enterprise.members.service_users.with_raw_response.delete(
                "",
            )
    ...
    def test_method_assign(self, client: DevinPlatform) -> None:
        service_user = client.enterprise.members.service_users.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    def test_raw_response_assign(self, client: DevinPlatform) -> None:
        response = client.enterprise.members.service_users.with_raw_response.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
    ...
    def test_streaming_response_assign(self, client: DevinPlatform) -> None:
        with client.enterprise.members.service_users.with_streaming_response.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_assign(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            client.enterprise.members.service_users.with_raw_response.assign(
                service_user_id="",
                role_id="role_id",
            )
...
class TestAsyncServiceUsers:
    ...
    async def test_method_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        service_user = await async_client.enterprise.members.service_users.retrieve(
            "service-user-abc123def456",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.enterprise.members.service_users.with_raw_response.retrieve(
            "service-user-abc123def456",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.enterprise.members.service_users.with_streaming_response.retrieve(
            "service-user-abc123def456",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            await async_client.enterprise.members.service_users.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncDevinPlatform) -> None:
        service_user = await async_client.enterprise.members.service_users.update(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.enterprise.members.service_users.with_raw_response.update(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.enterprise.members.service_users.with_streaming_response.update(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            await async_client.enterprise.members.service_users.with_raw_response.update(
                service_user_id="",
                role_id="role_id",
            )
    ...
    async def test_method_list(self, async_client: AsyncDevinPlatform) -> None:
        service_user = await async_client.enterprise.members.service_users.list()
        assert_matches_type(PaginatedServiceUser, service_user, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.enterprise.members.service_users.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.enterprise.members.service_users.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncDevinPlatform) -> None:
        service_user = await async_client.enterprise.members.service_users.delete(
            "service-user-abc123def456",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.enterprise.members.service_users.with_raw_response.delete(
            "service-user-abc123def456",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.enterprise.members.service_users.with_streaming_response.delete(
            "service-user-abc123def456",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            await async_client.enterprise.members.service_users.with_raw_response.delete(
                "",
            )
    ...
    async def test_method_assign(self, async_client: AsyncDevinPlatform) -> None:
        service_user = await async_client.enterprise.members.service_users.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
        assert_matches_type(ServiceUser, service_user, path=["response"])
    ...
    async def test_raw_response_assign(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.enterprise.members.service_users.with_raw_response.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        )
    ...
    async def test_streaming_response_assign(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.enterprise.members.service_users.with_streaming_response.assign(
            service_user_id="service-user-abc123def456",
            role_id="role_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_assign(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `service_user_id` but received ''"):
            await async_client.enterprise.members.service_users.with_raw_response.assign(
                service_user_id="",
                role_id="role_id",
            )
