...
class TestInsights:
    ...
    def test_method_retrieve(self, client: DevinPlatform) -> None:
        insight = client.organizations.sessions.insights.retrieve(
    ...
    def test_raw_response_retrieve(self, client: DevinPlatform) -> None:
        response = client.organizations.sessions.insights.with_raw_response.retrieve(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
    ...
    def test_streaming_response_retrieve(self, client: DevinPlatform) -> None:
        with client.organizations.sessions.insights.with_streaming_response.retrieve(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.organizations.sessions.insights.with_raw_response.retrieve(
                devin_id="devin-abc123def456",
                org_id="",
            )
    ...
    def test_method_generate(self, client: DevinPlatform) -> None:
        insight = client.organizations.sessions.insights.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
    ...
    def test_raw_response_generate(self, client: DevinPlatform) -> None:
        response = client.organizations.sessions.insights.with_raw_response.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
    ...
    def test_streaming_response_generate(self, client: DevinPlatform) -> None:
        with client.organizations.sessions.insights.with_streaming_response.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_generate(self, client: DevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.organizations.sessions.insights.with_raw_response.generate(
                devin_id="devin-abc123def456",
                org_id="",
            )
...
class TestAsyncInsights:
    ...
    async def test_method_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        insight = await async_client.organizations.sessions.insights.retrieve(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
        assert_matches_type(SessionInsights, insight, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.organizations.sessions.insights.with_raw_response.retrieve(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.organizations.sessions.insights.with_streaming_response.retrieve(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.organizations.sessions.insights.with_raw_response.retrieve(
                devin_id="devin-abc123def456",
                org_id="",
            )
    ...
    async def test_method_generate(self, async_client: AsyncDevinPlatform) -> None:
        insight = await async_client.organizations.sessions.insights.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
        assert_matches_type(SessionInsightsGenerate, insight, path=["response"])
    ...
    async def test_raw_response_generate(self, async_client: AsyncDevinPlatform) -> None:
        response = await async_client.organizations.sessions.insights.with_raw_response.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        )
    ...
    async def test_streaming_response_generate(self, async_client: AsyncDevinPlatform) -> None:
        async with async_client.organizations.sessions.insights.with_streaming_response.generate(
            devin_id="devin-abc123def456",
            org_id="org-abc123def456",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_generate(self, async_client: AsyncDevinPlatform) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.organizations.sessions.insights.with_raw_response.generate(
                devin_id="devin-abc123def456",
                org_id="",
            )
