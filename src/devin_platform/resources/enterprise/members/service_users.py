...
from ....types.enterprise.members import (
    service_user_list_params,
    service_user_assign_params,
...
class ServiceUsersResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v3/enterprise/members/service-users/{service_user_id}", service_user_id=service_user_id),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    service_user_list_params.ServiceUserListParams,
                ),
            ),
    ...
    def assign(
        ...
        *,
        ...
        return self._post(
            path_template("/v3/enterprise/members/service-users/{service_user_id}", service_user_id=service_user_id),
            body=maybe_transform({"role_id": role_id}, service_user_assign_params.ServiceUserAssignParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ServiceUser,
    ...
    async def assign(
        ...
        *,
        ...
        return await self._post(
            path_template("/v3/enterprise/members/service-users/{service_user_id}", service_user_id=service_user_id),
            body=await async_maybe_transform({"role_id": role_id}, service_user_assign_params.ServiceUserAssignParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ServiceUser,
