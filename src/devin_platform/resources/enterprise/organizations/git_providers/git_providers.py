...
class GitProvidersResourceWithRawResponse:
    ...
    def permissions(self) -> PermissionsResourceWithRawResponse:
        return PermissionsResourceWithRawResponse(self._git_providers.permissions)
...
class AsyncGitProvidersResourceWithRawResponse:
    ...
    def permissions(self) -> AsyncPermissionsResourceWithRawResponse:
        return AsyncPermissionsResourceWithRawResponse(self._git_providers.permissions)
...
class GitProvidersResourceWithStreamingResponse:
    ...
    def permissions(self) -> PermissionsResourceWithStreamingResponse:
        return PermissionsResourceWithStreamingResponse(self._git_providers.permissions)
...
class AsyncGitProvidersResourceWithStreamingResponse:
    ...
    def permissions(self) -> AsyncPermissionsResourceWithStreamingResponse:
        return AsyncPermissionsResourceWithStreamingResponse(self._git_providers.permissions)
