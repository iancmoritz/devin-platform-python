...
from ....types.organizations.knowledge import note_list_params, note_create_params, note_update_params
...
class NotesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/v3/organizations/{org_id}/knowledge/notes", org_id=org_id),
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v3/organizations/{org_id}/knowledge/notes/{note_id}", org_id=org_id, note_id=note_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=KnowledgeNote,
