...
from ....types.organizations.sessions import tag_append_params, tag_replace_params
...
class TagsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v3/organizations/{org_id}/sessions/{devin_id}/tags", org_id=org_id, devin_id=devin_id),
    ...
    def append(
        ...
        *,
        ...
        return self._post(
            path_template("/v3/organizations/{org_id}/sessions/{devin_id}/tags", org_id=org_id, devin_id=devin_id),
            body=maybe_transform({"tags": tags}, tag_append_params.TagAppendParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SessionTagsResponse,
    ...
    def replace(
        ...
        *,
        ...
        return self._put(
            path_template("/v3/organizations/{org_id}/sessions/{devin_id}/tags", org_id=org_id, devin_id=devin_id),
            body=maybe_transform({"tags": tags}, tag_replace_params.TagReplaceParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SessionTagsResponse,
    ...
    async def append(
        ...
        *,
        ...
        return await self._post(
            path_template("/v3/organizations/{org_id}/sessions/{devin_id}/tags", org_id=org_id, devin_id=devin_id),
            body=await async_maybe_transform({"tags": tags}, tag_append_params.TagAppendParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SessionTagsResponse,
    ...
    async def replace(
        ...
        *,
        ...
        return await self._put(
            path_template("/v3/organizations/{org_id}/sessions/{devin_id}/tags", org_id=org_id, devin_id=devin_id),
            body=await async_maybe_transform({"tags": tags}, tag_replace_params.TagReplaceParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SessionTagsResponse,
