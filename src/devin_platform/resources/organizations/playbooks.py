...
from ...types.organizations import playbook_list_params, playbook_create_params, playbook_update_params
...
class PlaybooksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/v3/organizations/{org_id}/playbooks", org_id=org_id),
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v3/organizations/{org_id}/playbooks/{playbook_id}", org_id=org_id, playbook_id=playbook_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=PlaybookResponse,
